...
class S3Util:
    ...
    @staticmethod
    def put_bytes(bucket: str, key: str, data: bytes, region: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def get_unicode(bucket: str, key: str, encoding: str = 'utf-8', region: Optional[str] = None) -> str:
        """
    ...
    @staticmethod
    def put_unicode(bucket: str, key: str, data: str, encoding: str = 'utf-8', region: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def put_dict(bucket: str, key: str, data: Dict[str, Any], indent: Optional[int] = None, region: Optional[str] = None) -> Dict[str, Any]:
        """

...
def test_bda_service_init_with_defaults(mock_boto3):
    ...
    assert service._dataAutomationProfileArn == "arn:aws:bedrock:us-west-2:123456789012:data-automation-profile/us.data-automation-v1"
...
def test_bda_service_init_with_all_params(mock_boto3):
    ...
    assert service._output_s3_uri == "s3://output-bucket/output-path"
    assert service._dataAutomationProjectArn == "arn:aws:bedrock:us-west-2:123456789012:data-automation-project/project-id"
    assert service._dataAutomationProfileArn == "arn:aws:bedrock:us-west-2:123456789012:data-automation-profile/custom-profile"
    assert service._bda_client == mock_bda_client
...
def test_invoke_data_automation_async_with_blueprint(mock_boto3, mock_uuid):
    ...
    expected_payload = {
        ...
        "inputConfiguration": {
            's3Uri': "s3://input-bucket/input-path/document.pdf"
        },
        "outputConfiguration": {
    ...
    mock_bda_client.invoke_data_automation_async.assert_called_once_with(**expected_payload)

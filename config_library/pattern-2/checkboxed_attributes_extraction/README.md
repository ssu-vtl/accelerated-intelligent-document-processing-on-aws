...
<div style="display: flex; justify-content: space-between; gap: 20px;">
  ...
  <figure style="text-align: center; flex: 1;">
    ...
    <img src="images/kie_checkbox_pre.png" alt="Before prompt optimization" style="width: 50%; max-width: 50px;">
  </figure>

  <figure style="text-align: center; flex: 1;">
    <figcaption style="font-weight: bold; text-align: center; margin-bottom: 8px;">After</figcaption>
    <img src="images/kie_checkbox_post.png" alt="After prompt optimization" style="width: 50%; max-width: 50px;">
  </figure>

...
echo CLI Deploy: aws cloudformation deploy --region $REGION --template-file $tmpdir/packaged.yaml --capabilities CAPABILITY_NAMED_IAM CAPABILITY_AUTO_EXPAND --stack-name IDP
echo Done
exit 0
